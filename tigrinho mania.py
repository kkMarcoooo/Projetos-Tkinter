...
conexao = sqlite3.connect("dados_onca")
...
def login():
    ...
    # =====~Send~===========----------
    send_button = tk.Button(frame_menu, text="Send")
    send_button.place(relx=0.73,rely=0.65,relwidth=0.25,relheight=0.08, anchor="center")

    tk.Label(frame_menu, text="Create Account", bg="#222626", fg="White", font=("Agency FB", 28,"bold")).place(relx=0.73, rely=0.08, anchor="center")
    tk.Label(frame_menu, text="🐯", bg="#403f3e", fg="#ffd900", font=("Arial", 90)).place(relx=0.23, rely=0.5,anchor="center")
    tk.Label(frame_menu, text="O N Ç A", bg="#403f3e", fg="#ffd900", font=("Arial", 50)).place(relx=0.23, rely=0.37,anchor="center")
...
def cadastro():
    ...
    usernameLogin.place(relx=0.56, rely=0.19, anchor="center")
    username_entry = tk.Entry(frame_menu, highlightbackground="black", highlightthickness=2, font=("Arial", 14))
    username_entry.place(relx=0.73,rely=0.24,relwidth=0.4,relheight=0.08,anchor="center")
    # =====~Email~===========----------
    emailLogin = tk.Label(frame_menu, text="Email", bg ="#222626", fg="white" )
    emailLogin.place(relx=0.55, rely=0.32, anchor="center")
    email_entry = tk.Entry(frame_menu, highlightbackground="black", highlightthickness=2, font=("Arial", 14))
    email_entry.place(relx=0.73,rely=0.37,relwidth=0.4,relheight=0.08,anchor="center")
    # =====~Password~===========----------
    passwordLogin = tk.Label(frame_menu, text="Password", bg ="#222626", fg="white" )
    passwordLogin.place(relx=0.56, rely=0.45, anchor="center")
    password_entry= tk.Entry(frame_menu, highlightbackground="black", highlightthickness=2, font=("Arial", 14), show="*")
    ...
    passwordConfirmLogin.place(relx=0.59, rely=0.58, anchor="center")
    passwordConfirm_entry= tk.Entry(frame_menu, highlightbackground="black", highlightthickness=2, font=("Arial", 14), show="*")
    passwordConfirm_entry.place(relx=0.73,rely=0.63,relwidth=0.4,relheight=0.08,anchor="center")
    # =====~Send~===========----------
    send_button = tk.Button(frame_menu, text="Send")
    send_button.place(relx=0.73,rely=0.8,relwidth=0.25,relheight=0.08, anchor="center")
    tk.Label(frame_menu, text="Login", bg="#222626", fg="White", font=("Agency FB", 28,"bold")).place(relx=0.73, rely=0.08, anchor="center")
    tk.Label(frame_menu, text="🐯", bg="#403f3e", fg="#ffd900", font=("Arial", 90)).place(relx=0.23, rely=0.5,anchor="center")
    tk.Label(frame_menu, text="O N Ç A", bg="#403f3e", fg="#ffd900", font=("Arial", 50)).place(relx=0.23, rely=0.37,anchor="center")
